        ...
        <tbody>
            <?php $i = 1;foreach ($data['frekuensi'] as $frekuensi): ?>
                <tr>
                    ...
                    <td style="position: relative;"><a class="btn-crud" href="<?= BASEURL; ?>/frekuensi/edit/<?= $frekuensi['id_frekuensi']; ?>"><i class="fa fa-pen-to-square"></i></a></td>
...
if ($_SESSION['role'] == 'Asisten' ) { 
    $data['frekuensi'] = $this->model('Frekuensi_model')->getFrekuensibyUser($_SESSION['id_user']);
?>
<div class="content">
    <h2 style="margin-top: 70px;">Frekuensi</h2>
    <table>
