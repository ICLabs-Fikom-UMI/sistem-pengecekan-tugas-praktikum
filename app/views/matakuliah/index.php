        ...
        <tbody>
            <?php foreach ($data['matakuliah'] as $matakuliah): ?>
                <tr>
                    ...
                    <td><a href="<?= BASEURL; ?>/matakuliah/edit/<?= $matakuliah['id_matkul']; ?>"><i class="fa fa-pencil"></i> Edit</a></td>
                    <td><a href="<?= BASEURL; ?>/matakuliah/hapus/<?= $matakuliah['id_matkul']; ?>" onclick="return confirm('Anda yakin ingin menghapus?');"><i class="fa fa-trash-can"></i> Hapus</a></td>
                </tr>
            <?php endforeach; ?>
        </tbody>
    </table>
